  ...
  return (
    <>
      <div className={styles.imgViewer}>
        <img src={source} alt="8ana" className={styles.img} />
      ...
      <Modal visible={state.visible} onCancel={methods.cancel} width="900" footer={null} centered bodyStyle={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
