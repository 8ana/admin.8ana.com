...
export class Category extends Model<InitialState> {
  ...
  methods = {
    getCategoryList: (query: ListQuery) => super.init<ListRes>(Methods.GET, Urls.queryAnimate, { query }, this.initDispatch.animate),
    getCategoryType: (params: CategoryTypeQuery) => super.init<List[]>(Methods.GET, Urls.queryCategoryType, { params }),
  };
}
