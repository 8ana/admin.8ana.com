...
const getLang = (key: LanguageKeys, addon?: { [key: string]: string | number }) => intlDefault.get(key, addon);

const getHTML = (key: LanguageKeys, addon?: { [key: string]: string | number }) => intlDefault.getHTML(key, addon);
