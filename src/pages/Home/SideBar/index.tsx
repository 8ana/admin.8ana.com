...
const SideBar: FC = () => {
  ...
  return (
    <Menu theme={theme} mode="inline" selectedKeys={[selectKey()]} defaultOpenKeys={[openKeys()]} onSelect={menuSelect}>
      <Menu.SubMenu key="/dashboard" icon={<DashboardOutlined />} title={getLang('common.menu.dashboard')}>
        <Menu.Item key="/dashboard/analysis">{getLang('common.menu.dashboard.analysis')}</Menu.Item>
        <Menu.Item key="/dashboard/workplace">{getLang('common.menu.dashboard.workplace')}</Menu.Item>
      </Menu.SubMenu>
      <Menu.SubMenu key="/animate" icon={<VideoCameraOutlined />} title={getLang('common.menu.animate')}>
      ...
      <Menu.SubMenu key="/eposide" icon={<YoutubeOutlined />} title={getLang('common.menu.eposide')}>
      ...
      <Menu.SubMenu key="/feedback" icon={<CommentOutlined />} title={getLang('common.menu.feedback')}>
      ...
      <Menu.SubMenu key="/cloud" icon={<CloudServerOutlined />} title={getLang('common.menu.cloud')}>
      ...
      <Menu.SubMenu key="/manaager" icon={<SettingOutlined />} title={getLang('common.menu.manager')}>
